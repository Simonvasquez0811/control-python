...
#Esta función calcula el pago total basado en las horas trabajadas, la tarifa por hora (con un valor predeterminado) y la moneda (con un valor predeterminado). Devuelve una cadena con el total y la moneda.