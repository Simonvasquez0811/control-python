...
# Este código define una función que formatea un texto según varias opciones, demostrando el uso de parámetros con valores por defecto y argumentos nombrados.